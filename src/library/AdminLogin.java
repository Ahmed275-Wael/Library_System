...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Admin.getPassword().equals(adminPasswordField.getText()) && adminTextField.getText().equals(Admin.getName())){
        AdminSection adminSec1 = new AdminSection();
        adminSec1.setVisible(true);
        dispose();
        }
        else JOptionPane.showMessageDialog(this,"Invalid name or password");
